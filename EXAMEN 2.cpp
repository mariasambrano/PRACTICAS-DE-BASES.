...
cout<<"a)hola mundo"<<endl;
cout<<"b)es vocal"<<endl;
cout<<"c)es vocal"<<endl;
cout<<"d)tablas de multiplicar"<<endl;
cout<<"e)1 al 1000"<<endl;
cout<<"f)cronometro"<<endl;
cout<<"g)portada"<<endl;
cout<<"h)porta con prinf"<<endl;
cout<<"i)switch"<<endl;
cout<<"j)asistencia"<<endl;
cout<<"k)dia"<<endl;
cout<<"l)1 al 100"<<endl;
cout<<"m)año de nacimiento"<<endl;
    }
	do {
		char opc;
	cout <<"a)hola mundo "
